...
namespace LogginPJ.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserRegisterRequest request)
        {
            if (_context.Users.Any(e => e.Email == request.Email))
                return BadRequest("User alteady existes.");
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(e => e.VerificationToken == token);
            if (user == null)
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(e => e.PasswordResetToken == request.Token);
